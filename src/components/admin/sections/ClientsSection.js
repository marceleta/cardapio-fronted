/**
 * @fileoverview Seção de Gestão de Clientes - Versão Modularizada
 * @description Componente que integra todos os módulos do sistema de clientes
 * @author Sistema de Gestão de Cardápio
 * @version 3.0.0 - Modularização completa seguindo CODING_STANDARDS.md
 * 
 * Funcionalidades:
 * - ✅ Componentes modulares especializados
 * - ✅ Hook customizado para estado centralizado
 * - ✅ Dialogs modulares para interações
 * - ✅ Separação clara de responsabilidades
 * - ✅ Código limpo e manutenível (787 → ~120 linhas)
 */
